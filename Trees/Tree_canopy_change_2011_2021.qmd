...
noho_change |> 
  ...
  pivot_wider(names_from='Year', 
              values_from=c('Coverage', Area)) |> 
  mutate(Change=`Coverage_2021`-`Coverage_2011`,
         Acre_Change=Area_2021*Change) |> 
  arrange(desc(`Coverage_2011`)) |> 
  select(-starts_with('Area')) |> 
  gt() |> 
  cols_label(Change='Percent',
             Acre_Change='Acres') |> 
  fmt_percent(columns=-Acre_Change, decimals=1) |>
  fmt_number(columns=Acre_Change, decimals=0) |> 
  tab_spanner('Change', Change:Acre_Change, id='changes') |> 
  tab_spanner_delim('_', starts_with('Coverage')) |> 
  tab_header(title='Change in tree canopy coverage in Northampton, 2011-2021') |> 
...
center_change |> 
  ...
  select(-starts_with('Area')) |> 
  gt() |> 
  cols_label(City='City center',
             Change='Percent',
             Acre_Change='Acres') |> 
  fmt_percent(columns=-c(City, Acre_Change), decimals=1) |>
  fmt_number(columns=Acre_Change, decimals=1) |> 
  tab_spanner('Change', Change:Acre_Change, id='changes') |> 
  tab_spanner_delim('_', starts_with('Coverage')) |> 
  tab_header(title='Change in tree canopy coverage in city centers, 2011-2021') |> 
  tab_source_note(table_caption)
```
...
zone_change |> 
  ...
  select(-starts_with('Area')) |> 
  gt() |> 
  cols_label(Class='Zoning class',
             Change='Percent',
             Acre_Change='Acres') |> 
  fmt_percent(columns=-c(Class, Acre_Change), decimals=1) |>
  fmt_number(columns=Acre_Change, decimals=1) |> 
  tab_spanner('Change', Change:Acre_Change, id='changes') |> 
  tab_spanner_delim('_', starts_with('Coverage')) |> 
  tab_header(title='Change in tree canopy coverage by zoning category, 2011-2021') |> 
  tab_source_note(table_caption)
```
