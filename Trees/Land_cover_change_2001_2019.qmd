...
# Sankey chart
sankey_plot = function(mask, where) {
  lc_change = 
...
The chart below gives a more nuanced view. It shows that some forest
land has become herbaceous/shrub and most of the lost cultivated
land has been developed.

```{r noho_chart2}
sankey_plot(noho_sp, 'Northampton')
```
...
These tabs show land cover by zoning category. The categories
aggregate the City zoning districts.
...
sankey_plot(zone_sp, class_text)
