...
Possible planting sites in Northampton, Florence and Leeds town centers,
...
Click the checkboxes to filter the data.

```{r map}
filter_checkbox("own", "Ownership", shared_qmile, ~Owner, inline = TRUE)
filter_checkbox('under', 'Under wire?', shared_qmile, ~`Under wire`, inline=TRUE)
