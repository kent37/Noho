...
was between 55% and 59% for the entire period 1985-2023.

Canopy coverage
increased greatly from
**`r percent(noho_min, accuracy=0.1)` in 1987** to a **high of
`r percent(noho_max, accuracy=0.1)` in 2013**,
then decreased to **`r percent(noho_coverage$Coverage[39], accuracy=0.1)` in 2023**.
...
since the 1985 baseline.

Leeds is the only city center with increased canopy coverage from 1985 to 2023.
...
ggplot(center_change, aes(Year, Change, color=City, group=City)) +
  ...
  labs(x='Year', y='Change in tree canopy coverage (%)',
       title='Change in tree canopy coverage in city centers, 1985-2023',
       caption=plot_caption) +
  guides(color='none')
```

This table shows the canopy coverage in 1985 and 2023 in the three city centers and the change in percent and acres.
...
since the 1985 baseline, by zoning category.

The canopy increase from 1985 to 2013 is mostly in the Rural and
...
ggplot(zone_change, aes(Year, Change, color=Class, group=Class)) +
  ...
  scale_y_continuous(minor_breaks=NULL,
                     labels=label_percent(accuracy=0.1)) +
  labs(x='Year', y='Change in tree canopy coverage (%)',
       title='Change in tree canopy coverage by zoning category, 1985-2023',
       caption=plot_caption) +
  guides(color='none')
```

This table shows the canopy coverage in 1985 and 2023 by zone.
...
The next chart shows the change in percent tree canopy
since the 1985 baseline, by ward and precinct.
...
ggplot(ward_change, aes(Year, Change, color=WardPrec, group=WardPrec)) +
  ...
  scale_y_continuous(minor_breaks=NULL,
                     labels=label_percent(accuracy=0.1)) +
  labs(x='Year', y='Change in tree canopy coverage (%)',
       title='Change in tree canopy coverage by ward and precinct, 1985-2023',
       caption=plot_caption) +
  guides(color='none')
```

This table shows the canopy coverage in 1985 and 2023 by ward and precinct.
...
This map shows the change in tree canopy percent from 1985 to 2023.
