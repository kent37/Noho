...
**`r percent(noho_coverage$Coverage[1], accuracy=0.1)` in 1987** to a **high of
`r percent(noho_max, accuracy=0.1)` in 2013**,
then decreased to **`r percent(noho_min, accuracy=0.1)` in 2023**.
